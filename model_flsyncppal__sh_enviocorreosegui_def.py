    ...
    def sanhigia_sync_enviocorreo():
        ...
        while q.next():
            ...
            if not email or email == "":
                ...
                cuerpo2 = '<h4>ACTUALIZACIÓN DE TU PEDIDO</h4><p>Tu pedido con albarán {0} ha sido enviado.<br>El número del seguimiento del pedido es {1}.</p>Puedes comprobar el estado del envio en {2}<br><br>Gracias, Sanhigia'.format(codigo, numtracking, urlsegui)
                cuerpo += cuerpo2
